...
<div class="container mt-4">
    ...
    <h1 class="mb-0 flex-grow-1 text-center fw-bolder">Pokedex</h1>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 shadow d-flex flex-column">
                    ...
                    <div class="d-flex justify-content-center align-items-center flex-grow-1 p-3">
                        <img src="<?= $poke['imagen'] ?>" class="img-fluid" style="max-height: 150px;">
                    </div>

                    <div class="card-body mt-auto">
                        <p class="card-text"><strong>Tipo:</strong> <?= $poke['tipo'] ?></p>
                        <p class="card-text"><strong>Región:</strong> <?= $poke['region'] ?></p>
                        <p class="card-text"><strong>Descripción:</strong> <?= $poke['descripcion'] ?></p>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
